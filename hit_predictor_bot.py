...
def start(update, context):
    ...
    context.bot.send_message(chat_id=chat_id,
                             text='Привет!\n\n'
                                  ...
                                  'При этом не забывай, что вероятность стать хитом зависит не только от самого трека, '
                                  'но и от масштаба его исполнителя. То есть 34%-ая вероятность трека стать хитом, '
                                  'если его исполняет Егор Крид, это не то же самое, если его исполняет ноунейм. '
                                  ...
                                  'трек, который ты мне присылаешь, должен быть в Spotify, по-другому я пока не умею, '
                                  'сорян')
        ...
        if not prediction:
            ...
            context.bot.send_message(chat_id=chat_id,
                                     text=f"Вот, что нашлось в Spotify, и что я об этом думаю:\n\n"
                                          ...
                                          f"И помни, что я пока не умею учитывать масштаб исполнителя и смысл текста.")
